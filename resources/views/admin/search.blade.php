<x-admin-layout title="{{ trans_choice('users.search_results', $users->count()) }} ">
    <div class="mt-8">
            ...
            <div
                ...
                <table class="min-w-full">
                    ...
                    <tbody class="bg-white">
                        ...
                        @empty
                            <tr>
                                <td class="text-sm text-center py-4" colspan="4">No user with found with your search terms!!</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
