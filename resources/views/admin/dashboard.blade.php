<x-admin-layout title="Dashboard">
        ...
        <div class="flex flex-wrap -mx-6">
            ...
            <div class="w-full mt-6 px-6 sm:w-1/2 xl:w-1/3 sm:mt-0">
                <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
                    ...
                    <div class="mx-5">
                        <h4 class="text-2xl font-semibold text-gray-700">{{ $fromOnline }}</h4>
                        <div class="text-gray-500">Online Tickets</div>
                    </div>
                </div>
            </div>
            ...
            <div class="w-full mt-6 px-6 sm:w-1/2 xl:w-1/3 xl:mt-0">
                <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
                    ...
                    <div class="mx-5">
                        <h4 class="text-2xl font-semibold text-gray-700">{{ $fromOffline }}</h4>
                        <div class="text-gray-500">Offline Tickets</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    @can('view-all-users')
        <section class="flex flex-col mt-8">
            <h2 class="text-xl font-semibold uppercase mb-4">Latest Users</h2>
                            ...
                            @foreach ($users as $user)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                        ...
                                        @endphp
                                        <span
                                            class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full {{ $colors }}">{{ $user->ticket?->name }}</span>
                                    </td>
    ...
    @cannot('view-all-users')
        <section class="flex flex-col mt-8">
            <h2 class="text-xl font-semibold uppercase mb-4">Your Referrals</h2>
            <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                <div
                    class="align-middle inline-block min-w-full shadow overflow-hidden sm:rounded-lg border-b border-gray-200">
                    <table class="min-w-full">
                        ...
                        <tbody class="bg-white">
                            ...
                            @empty
                                <tr>
                                    <td class="text-sm text-center py-4" colspan="4">You have not registered anybody for the
                                        PBS event. Please do so soon!!</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
